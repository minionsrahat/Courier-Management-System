...
?>
<?php
$qry = $conn->query("SELECT * FROM parcel_requests where id = " . $_GET['id'])->fetch_array();
foreach ($qry as $k => $v) {
    $$k = $v;
}
?>
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0"><?php echo 'HOME/EDIT PARCEL REQUEST' ?></h1>
                        </div><!-- /.col -->
                        ...
                        <div class="card card-outline card-primary">
                            <div class="card-body">
                                <form action="" id="manage-parcel">
                                    ...
                                    <input type="hidden" name="ref" value="<?php echo isset($reference_number) ? $reference_number : '' ?>">
                                        ...
                                        <div class="col-md-6" id="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="badge badge-primary"><?php
                                                                                    echo $payment_mode == 1 ? "Pay On Pick Up" : "Via Momo" ?></span>
                                    ...
                                    <table class="table table-bordered" id="parcel-items">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="text" class="text-right number" id="tAmount" name='price[]' value="<?php echo isset($price) ? $price : '' ?>" required></td>
                            ...
                            <div class="card-footer border-top border-info">
                                <div class="d-flex w-100 justify-content-center align-items-center">
                                    <button class="btn btn-flat  bg-gradient-primary mx-2" form="manage-parcel">Accept</button>
    ...
    <script>
        ...
        $('#manage-parcel').submit(function(e) {
            ...
            $.ajax({
                url: 'ajax.php?action=accept_parcel_request',
